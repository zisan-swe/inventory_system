                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-danger remove-row"><i
                                                class="bi bi-trash"></i>Remove</button></td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <script>
            $(document).ready(function() {
                ...
                <tr>
                    ...
                    <td><input type="number" name="quantities[]" class="form-control quantity" min="1" value="1" required></td>
                    <td><input type="text" name="prices[]" class="form-control price" readonly></td>
                    <td><input type="text" name="totals[]" class="form-control total" readonly></td>
                    <td><button type="button" class="btn btn-danger remove-row"><i class="bi bi-trash"></i>Remove</button></td>
                </tr>
            `;
